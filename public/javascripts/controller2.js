app.controller("TTRController",['$scope','$timeout','AgeCalculator','TaxRateCalculator','SGCRate','WithoutSSCalculator','WithSSCalculator','ChartServiceHc','DonutChartServiceHc','PdfMaker',function($scope,$timeout,AgeCalculator,TaxRateCalculator,SGCRate,WithoutSSCalculator,WithSSCalculator,ChartServiceHc,DonutChartServiceHc,PdfMaker){
  ...
  //   }
    ...
    $scope.maxTHP2 =  Math.floor(WithoutSSCalculator.getFinalAmount(ageq,fyq,csesq,thpq,true));
    ...
    $scope.submitForm2 = function(isValid){
      ...
      // var thp1=$scope.thp.replace("$","").replace(",","");
        ...
        $scope.resultWithoutSS = WithoutSSCalculator.getFinalAmount(ageq,fyq,csesq,thpq,false);
        ...
        $scope.resultWithSS = WithSSCalculator.getFinalAmount(ageq,fyq,csesq,thpq,$scope.taxWithoutSS);
  ...
  //   });
    ...
    document.getElementById("download").addEventListener("click",function(){
      ...
      PdfMaker.createChart($scope.dob,ageq,fyq,csesq,thpq,$scope.resultWithoutSS,$scope.resultWithSS,$scope.needSS,$scope.optimisedSS,toggleNeeded);
    });
...
// elem1.style.width ="240px";
// elem1.style.height ="65px";
// document.getElementById("chart-div").appendChild(elem1);
